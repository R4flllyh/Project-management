            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                {{-- <li class="nav-item px-3 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-white p-0">
                        <i class="fa fa-github fixed-plugin-button-nav cursor-pointer"></i>
                    </a>
                </li> --}}
                ...
                <li class="nav-item dropdown ps-3 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-white p-0" id="dropdownMenuButton"
                        ...
                        <i class="fi fi-rr-angle-small-down text-lg align-middle"></i>
                    </a>
                    <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                        aria-labelledby="dropdownMenuButton">
                        <li class="mb-0">
                        ...
                        <li class="mb-0">
                            <form role="form" method="post" action="{{ route('logout') }}" id="logout-form" class="dropdown-item border-radius-md px-1">
                                @csrf
                                <a href="{{ route('logout') }}"
